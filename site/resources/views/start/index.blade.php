...
<html lang="en-US">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="{{ asset('start/assets/') }}/favicon.ico" />
    ...
    <body>
        ...
        <!-- Bootstrap core JS-->
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/{{ asset('start/js') }}/bootstrap.bundle.min.js"></script>
        <!-- Core theme JS-->
